    ...
    ld.add_action(ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                package=pkg_name,
                plugin='mrs_fcu_hitl_binder::FcuHitlBinder',
                namespace='',
                name='fcu_binder',
                parameters=[
                ...
                remappings=[
                    ...
                    ("~/rangefinder", "/multirotor_simulator/uav1/rangefinder"),
                    ("~/imu", "/multirotor_simulator/uav1/imu_noise"),
                    ("~/odom", "/multirotor_simulator/uav1/odom_noise"),
                    ("~/actuators_cmd", "/multirotor_simulator/uav1/actuators_cmd"),
                    ("~/altitude", "/multirotor_simulator/uav1/altitude_noise"),
                    ("~/magnetometer", "/multirotor_simulator/uav1/magnetometer_noise"),
